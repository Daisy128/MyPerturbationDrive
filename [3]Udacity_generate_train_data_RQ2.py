...
road_angles_list4,road_segments_list4,road_types_list4=generate_random_roads()
road_angles_list5,road_segments_list5,road_types_list5=generate_s_roads()
road_angles_list6,road_segments_list6,road_types_list6=generate_s_roads()
road_angles_list7,road_segments_list7,road_types_list7=generate_random_roads()
road_angles_list9,road_segments_list9,road_types_list9=generate_simple_roads()
road_angles_list8,road_segments_list8,road_types_list8=generate_s_roads()
road_angles_list10,road_segments_list10,road_types_list10=generate_random_roads()
...
road_angles_list.extend(road_angles_list3)
road_segments_list.extend(road_segments_list3)
road_types_list.extend(road_types_list3)
road_angles_list.extend(road_angles_list4)
road_segments_list.extend(road_segments_list4)
road_types_list.extend(road_types_list4)
road_angles_list.extend(road_angles_list5)
road_segments_list.extend(road_segments_list5)
road_types_list.extend(road_types_list5)
road_angles_list.extend(road_angles_list6)
road_segments_list.extend(road_segments_list6)
road_types_list.extend(road_types_list6)
road_angles_list.extend(road_angles_list7)
road_segments_list.extend(road_segments_list7)
road_types_list.extend(road_types_list7)
road_angles_list.extend(road_angles_list8)
road_segments_list.extend(road_segments_list8)
road_types_list.extend(road_types_list8)
road_angles_list.extend(road_angles_list9)
road_segments_list.extend(road_segments_list9)
road_types_list.extend(road_types_list9)
road_angles_list.extend(road_angles_list10)
road_segments_list.extend(road_segments_list10)
road_types_list.extend(road_types_list10)

try:
    
    for i in range(0,len(road_angles_list)):
            simulator = UdacitySimulator(
                simulator_exe_path="/home/jiaqq/Project-1120/simulator/binary.x86_64",
                host="127.0.0.1",
                port=9091
            )
