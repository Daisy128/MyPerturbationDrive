...
road_angles_list=[[-37, 44, 53, -60, 69, 17, -1, -32, -43, 57],
...
try:
    ...
    # Done functions:
    # functions = ["defocus_blur", "glass_blur"， "sharpen_filter", "grayscale_filter", "cutout_filter", "sample_pairing_filter", "gaussian_blur", "saturation_filter", "saturation_decrease_filter", "fog_filter", "frost_filter", "snow_filter", "static_sun_filter", "static_rain_filter", "static_snow_filter", "static_smoke_filter", "object_overlay"]
    # only contains few roads
    # functions = ["impulse_noise", "motion_blur", "increase_brightness", "pixelate", "jpeg_filter", "shear_image", "translate_image", "scale_image", "rotate_image"]
    # Doing functions:
    functions = ["posterize_filter", "object_overlay", "reflection_filter", "white_balance_filter"] #, "reflection_filter", "white_balance_filter"]
