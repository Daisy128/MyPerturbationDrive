...
if __name__ == "__main__":
    ...
    parser.add_argument("--model", type=str,default="./checkpoints/roadGen_trained.h5", help="model name")
    parser.add_argument(
        "--epochs",
        type=int,
        default=100,
    ...
    parser.add_argument(
        "--inputs", default="/home/jiaqq/Project-1120/PerturbationDrive/examples/models/datasets/train_dataset/*.jpg", help="input mask to gather images"
    )
    parser.add_argument(
