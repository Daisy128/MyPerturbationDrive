...
class ImagePerturbation:
    ...
    def perturbation(
        ...
        """
        if perturbation_name == "" and image.shape[:2] != (self.height, self.width):
        ...
        if pertub_image.shape[:2] != (self.height, self.width):
            pertub_image = cv2.resize(pertub_image, (self.width, self.height))
